namespace Gpm.Ui
{
    ...
    public partial class InfiniteScroll : IMoveScroll
    {
        ...
        public void SetScrollPostion(float movePosition)
        {
            Vector2 prevPosition = GetScrollPostion();
            if (isVertical == true)
            {
        ...
        public void MoveTo(int dataIndex, MoveToType moveToType, float time = 0)
        {
            ...
            if (IsValidDataIndex(dataIndex) == true)
            {
                ...
                {
                    SetScrollPostion(GetMovePosition(dataIndex, isVertical, moveToType));
        ...
        public void MoveTo(float scrollRate, float time = 0)
        {
            ...
            {
                SetScrollPostion(GetMovePosition(scrollRate));
